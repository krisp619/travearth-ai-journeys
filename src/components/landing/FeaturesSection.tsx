...
const features = [
  {
    ...
    details: {
      highlights: [
        ...
        "Smart recommendations based on weather and season",
        "Alternative suggestions for popular attractions",
  ...
  },
  {
    ...
    details: {
      highlights: [
        ...
        "Currency conversion support for international trips",
        "Emergency fund allocation suggestions",
        "Budget tracking throughout your trip",
        "Value-for-money indicators for activities",
      ],
  ...
  },
  {
    ...
    details: {
      highlights: [
        ...
        "Sunset/sunrise timing for scenic spots",
        "Opening hours awareness for attractions",
      ],
  ...
  },
  {
    ...
    details: {
      highlights: [
        ...
        "Choices across budget ranges (hostels to luxury hotels)",
        "Optimized for shorter commutes to main attractions",
        "Neighborhood safety ratings and local insights",
        "Proximity to public transport and amenities",
        "Peak vs off-season pricing recommendations",
        "Family-friendly or solo traveler accommodations",
      ],
  ...
  },
  {
    ...
    details: {
      highlights: [
        ...
        "Local market and food tour suggestions",
        "Authentic restaurants frequented by locals",
      ],
  ...
  },
  {
    ...
    details: {
      highlights: [
        ...
        "Transportation pass recommendations (day/week passes)",
        "Airport transfer options and costs",
        "Car rental vs public transport comparisons",
  ...
  },
  {
    ...
    details: {
      highlights: [
        ...
        "Save multiple versions of your itinerary",
  ...
  },
  {
    ...
    details: {
      highlights: [
        ...
        "Export as PDF with maps and photos",
        "Print-friendly format for offline access",
        "Email directly to travel companions",
        "Sync with calendar apps (Google, Apple)",
      ],
